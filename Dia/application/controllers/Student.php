		...
		if(_is_user_login($this)){
          ...
          $filter = array();   
           if(isset($_GET['standard'])){
			...
			$a=140;
			$b=200;
			$data["studentP"] = $this->student_model->get_school_student_1($a,$b);
            $data["studentN"] = $this->student_model->get_school_student_2($a,$b);
            $data["studentD"] = $this->student_model->get_school_student_3($a,$b);
...
public function student_print1(){
      if(_is_user_login($this)){
           
            $this->load->model("student_model");
            $data["studentN"] = $this->student_model->get_school_student_2(140,200);
           
            $this->load->view("student/student_print1",$data);
        }
}

public function student_print2(){
      if(_is_user_login($this)){
           
            $this->load->model("student_model");
            $data["studentD"] = $this->student_model->get_school_student_1(140,200);
           
            $this->load->view("student/student_print2",$data);
        }
}
public function student_print3(){
      if(_is_user_login($this)){
           
            $this->load->model("student_model");
            $data["studentP"] = $this->student_model->get_school_student_3(200);
           
            $this->load->view("student/student_print3",$data);
        }
}
public function student_print4(){
      if(_is_user_login($this)){
           
            $this->load->model("student_model");
            $data["studentA"] = $this->student_model->get_school_student_4(92,95);
           
            $this->load->view("student/student_print4",$data);
        }
}
